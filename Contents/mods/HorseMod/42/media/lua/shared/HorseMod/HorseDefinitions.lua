...
AnimalDefinitions.breeds["horse"] = {
    breeds = {
        ["american_quarter"] = {
            ...
            invIconMale = "media/textures/Item_HorseAQHP_Foal.png",
            invIconFemale = "media/textures/Item_HorseAQHP_Foal.png",
            invIconBaby = "media/textures/Item_HorseAQHP_Foal.png",
            invIconMaleDead = "media/textures/Item_HorseAQHP_Dead.png",
            invIconFemaleDead = "media/textures/Item_HorseAQHP_Dead.png",
            invIconBabyDead = "media/textures/Item_HorseAQHP_Foal_Dead.png",
        },
        ["american_paint"] = {
            name = "american_paint",
            ...
            invIconMale = "media/textures/Item_HorseAP_Foal.png",
            invIconFemale = "media/textures/Item_HorseAP_Foal.png",
            invIconBaby = "media/textures/Item_HorseAP_Foal.png",
            invIconMaleDead = "media/textures/Item_HorseAP_Dead.png",
            invIconFemaleDead = "media/textures/Item_HorseAP_Dead.png",
            invIconBabyDead = "media/textures/Item_HorseAP_Foal_Dead.png",
        },
        ["appaloosa"] = {
            name = "appaloosa",
            ...
            invIconMale = "media/textures/Item_HorseGDA_Foal.png",
            invIconFemale = "media/textures/Item_HorseGDA_Foal.png",
            invIconBaby = "media/textures/Item_HorseGDA_Foal.png",
            invIconMaleDead = "media/textures/Item_HorseGDA_Dead.png",
            invIconFemaleDead = "media/textures/Item_HorseGDA_Dead.png",
            invIconBabyDead = "media/textures/Item_HorseGDA_Foal_Dead.png",
        },
        ["thoroughbred"] = {
            name = "thoroughbred",
            ...
            invIconMale = "media/textures/Item_HorseT_Foal.png",
            invIconFemale = "media/textures/Item_HorseT_Foal.png",
            invIconBaby = "media/textures/Item_HorseT_Foal.png",
            invIconMaleDead = "media/textures/Item_HorseT_Dead.png",
            invIconFemaleDead = "media/textures/Item_HorseT_Dead.png",
            invIconBabyDead = "media/textures/Item_HorseT_Foal_Dead.png",
        },
        ["blue_roan"] = {
            name = "blue_roan",
            ...
            invIconMale = "media/textures/Item_HorseAQHBR_Foal.png",
            invIconFemale = "media/textures/Item_HorseAQHBR_Foal.png",
            invIconBaby = "media/textures/Item_HorseAQHBR_Foal.png",
            invIconMaleDead = "media/textures/Item_HorseAQHBR_Dead.png",
            invIconFemaleDead = "media/textures/Item_HorseAQHBR_Dead.png",
            invIconBabyDead = "media/textures/Item_HorseAQHBR_Foal_Dead.png",
        },
        ["spotted_appaloosa"] = {
            ...
            invIconMale = "media/textures/Item_HorseLPA_Foal.png",
            invIconFemale = "media/textures/Item_HorseLPA_Foal.png",
            invIconBaby = "media/textures/Item_HorseLPA_Foal.png",
            invIconMaleDead = "media/textures/Item_HorseLPA_Dead.png",
            invIconFemaleDead = "media/textures/Item_HorseLPA_Dead.png",
            invIconBabyDead = "media/textures/Item_HorseLPA_Foal_Dead.png",
        },
        ["american_paint_overo"] = {
            ...
            invIconMale = "media/textures/Item_HorseAPHO_Foal.png",
            invIconFemale = "media/textures/Item_HorseAPHO_Foal.png",
            invIconBaby = "media/textures/Item_HorseAPHO_Foal.png",
            invIconMaleDead = "media/textures/Item_HorseAPHO_Dead.png",
            invIconFemaleDead = "media/textures/Item_HorseAPHO_Dead.png",
            invIconBabyDead = "media/textures/Item_HorseAPHO_Foal_Dead.png",
        },
        ["flea_bitten_grey"] = {
            ...
            invIconMale = "media/textures/Item_HorseFBG_Foal.png",
            invIconFemale = "media/textures/Item_HorseFBG_Foal.png",
            invIconBaby = "media/textures/Item_HorseFBG_Foal.png",
            invIconMaleDead = "media/textures/Item_HorseFBG_Dead.png",
            invIconFemaleDead = "media/textures/Item_HorseFBG_Dead.png",
            invIconBabyDead = "media/textures/Item_HorseFBG_Foal_Dead.png",
        },
    }
}
